...
public class AnalysisPluginIT extends ESIntegTestCase {

    @Override
    protected Collection<Class<? extends Plugin>> nodePlugins() {
        return Collections.singletonList(AnalysisTestPlugin.class);
    }
    ...
    public void testBasicUsage() {
        ...
        for (AnalysisTestcases testcase : testCases) {
            AnalyzeAction.Request analyzeRequest = new AnalyzeAction.Request(index).tokenizer("standard")
                .addTokenFilter("analysis_test_word_filter")
